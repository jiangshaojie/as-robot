...
class Test_json():
    ...
    @pytest.mark.parametrize("cases", getcase("sf_quanchangjing.xlsx"))
    @run
    def test_sf_quanchangjing(self, cases):
        pass

    @pytest.mark.parametrize("cases", getcase("sf_waihu.xlsx"))
    @run
    def test_sf_waihu(self, cases):
        pass

    @pytest.mark.parametrize("cases", getcase("sf_fengchao.xlsx"))
    @run
    def test_sf_fengchao(self, cases):
        pass
